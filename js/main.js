...
map.on('load', () => { //simplifying the function statement: arrow with brackets to define a function
    ...
    map.addSource('basemap', {
        ...
        'tileSize': 256,
        'attribution': 'A Basemap showing study area</a>'
    });
    ...
    map.addSource('thematicLayer', {
        ...
        'tileSize': 256,
        'attribution': 'A thematic layer showing public schools in Seattle</a>'
    });
    ...
    map.addSource('mapDesign', {
        ...
        'tileSize': 256,
        'attribution': 'A creative map design layer</a>'
    });
